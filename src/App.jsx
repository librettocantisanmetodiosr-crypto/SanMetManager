  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
        ...
        {/* Coro */}
        <Route path="coro/canti"   element={<ProtectedRoute ruoli={['admin','parroco','responsabile_coro','corista','neocatecumenale','responsabile_neo','comitato','segreteria']}><CoroCanti /></ProtectedRoute>} />
