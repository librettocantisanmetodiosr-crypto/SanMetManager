        ...
        >
          ...
          >
            ...
            <div style={{ background: 'var(--primary)', padding: '24px 20px 20px', color: '#fff' }}>
              <div style={{ width: 48, height: 48, borderRadius: '50%', background: 'rgba(255,255,255,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.1rem', fontWeight: 800, marginBottom: 10 }}>{initiali}</div>
              <div style={{ fontWeight: 800, fontSize: '1rem' }}>{profilo?.nome} {profilo?.cognome}</div>
  ...
  return (
    <NavLink
      ...
      style={({ isActive }) => ({
        ...
        textDecoration: 'none', borderLeft: isActive ? '3px solid var(--primary)' : '3px solid transparent'
      })}
    >
